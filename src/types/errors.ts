...
export const ErrorCodes = {
    ...
    YAML_INVISIBLE_KEY:   "YAML_INVISIBLE_KEY",
    LUA_INVISIBLE_KEY:    "LUA_INVISIBLE_KEY",
    ...
    DOCTOR_REPAIR_REJECTED: "DOCTOR_REPAIR_REJECTED",
    KEYRING_CORRUPT:      "KEYRING_CORRUPT",
    UNTRUSTED_SIGNER:     "UNTRUSTED_SIGNER",
    BUILTIN_KEYRING_HASH_MISMATCH: "BUILTIN_KEYRING_HASH_MISMATCH",
    BUILTIN_KEYRING_TOO_LARGE: "BUILTIN_KEYRING_TOO_LARGE",
    BUILTIN_KEYRING_INVALID: "BUILTIN_KEYRING_INVALID",
    BUILTIN_KEY_NOT_REMOVABLE: "BUILTIN_KEY_NOT_REMOVABLE",
    BUILTIN_KEY_ALREADY_TRUSTED: "BUILTIN_KEY_ALREADY_TRUSTED",
    GATE_PRODUCER_FAILED: "GATE_PRODUCER_FAILED",
